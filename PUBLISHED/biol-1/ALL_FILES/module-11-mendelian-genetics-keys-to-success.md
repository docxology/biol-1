# Module 11: Inheritance — Mendelian & Polygenic Genetics — Keys to Success
...
- **Multiple Alleles** — More than two alleles exist for a gene in the population (e.g., ABO blood: Iᴬ, Iᴮ, i)
...
- **X-Linked Recessive** — Affected males: XᵃY; carrier females: XᴬXᵃ; affected females: XᵃXᵃ (rare)
...
|-----------|-------|-----------------|
| **Monohybrid** | Aa × Aa | **3:1** (3 dominant : 1 recessive) |
| **Monohybrid (genotypic)** | Aa × Aa | 1:2:1 (1 AA : 2 Aa : 1 aa) |
| **Test Cross** | Aa × aa | 1:1 (1 dominant : 1 recessive) |
| **Dihybrid** | AaBb × AaBb | **9:3:3:1** |
| **Incomplete Dominance** | Rr × Rr | 1:2:1 (1 red : 2 pink : 1 white) |

## ABO Blood Type: A Model of Multiple Alleles + Codominance

| Genotype | Phenotype (Blood Type) | Antigens on RBCs |
|----------|----------------------|-----------------|
| IᴬIᴬ or Iᴬi | Type A | A antigen |
| IᴮIᴮ or Iᴮi | Type B | B antigen |
| IᴬIᴮ | Type AB (codominance) | Both A and B |
| ii | Type O | Neither |
...
- **Autosomal Recessive**: Can skip generations; two carrier parents → ¼ chance of affected child
- **X-Linked Recessive**: More males affected; affected fathers pass carrier status to ALL daughters; carrier mothers pass to ½ sons
...
3. **Blood types are a favorite exam topic** — Master the Iᴬ, Iᴮ, i system
4. **Pedigree practice** — Work through pedigrees asking: dominant or recessive? Autosomal or sex-linked?
5. **Polygenic ≠ Mendelian** — Polygenic traits have continuous variation, not simple dominant/recessive ratios
6. **Genotype ≠ Phenotype** — Remember that environment modifies expression (e.g., hydrangea color changes with soil pH)
7. **Connect to Module 9** — Segregation happens during Meiosis I; independent assortment happens at Metaphase I
