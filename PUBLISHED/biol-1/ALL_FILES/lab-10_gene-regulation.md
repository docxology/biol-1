# Lab 10: Gene Regulation & Epigenetics
...
<!-- lab:reflection -->
**4. Summarize the fundamental difference in strategies: How does a bacterium (using an operon) control gene expression compared to how a eukaryote (using epigenetics) controls gene expression?**
