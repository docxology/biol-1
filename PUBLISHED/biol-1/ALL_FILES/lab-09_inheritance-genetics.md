...
## Part 1: Vocabulary and Mendel's Laws
...
| **Genotype** | {fill:text} |
| **Phenotype** | {fill:text} |
| **Homozygous** | {fill:text} |
| **Heterozygous** | {fill:text} |
| **Dominant** | {fill:text} |
| **Recessive** | {fill:text} |
| **Carrier** | {fill:text} |
...
- Genotypic ratio: {fill:text}
- Phenotypic ratio: {fill:text}
- What percentage of offspring will be short? {fill:text}
...
- Genotypic ratio: {fill:text}
- Phenotypic ratio: {fill:text}
- What is the chance of a homozygous recessive (tt) offspring? {fill:text}
...
<!-- lab:reflection -->
**11. Cross two pink snapdragons (RR′ × RR′). Fill in the Punnett square:**
...
- Phenotypic ratio: ___ Red : ___ Pink : ___ White
...
## Part 5: ABO Blood Types — Codominance and Multiple Alleles

*The ABO blood system demonstrates both codominance (Iᴬ and Iᴮ are codominant) and multiple alleles (three alleles: Iᴬ, Iᴮ, i). This system determines which antigens are on your red blood cells and is essential for safe blood transfusions.*
...
|---|---|---|
| **Type A** | {fill:text} | A antigen |
| **Type B** | {fill:text} | B antigen |
| **Type AB** | {fill:text} | Both A and B |
| **Type O** | {fill:text} | Neither |

**14. A mother is Type A (Iᴬi) and a father is Type B (Iᴮi). Fill in the Punnett square:**
...
## Part 8: Polygenic Traits and the Environment
...
**26. Mendel's pea plants were either tall OR short (two categories). Human height shows a continuous range from very short to very tall. Why is human height distributed as a bell curve instead of two distinct categories?**

{fill:textarea rows=3}

**27. True or False: If you know someone's genotype, you always know their phenotype. Explain, giving a specific example where environment changes the phenotype.**

{fill:textarea rows=3}

**28. A student says: "Genes determine everything about you — environment doesn't matter." Do you agree or disagree? Give a specific example to support your answer.**
