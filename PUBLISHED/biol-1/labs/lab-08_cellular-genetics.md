...
|------|------------|
| **Chromatin** | {fill:text} |
| **Chromosome** | {fill:text} |
| **Sister chromatids** | {fill:text} |
| **Homologous chromosomes** | {fill:text} |
| **Diploid (2n)** | {fill:text} |
| **Haploid (n)** | {fill:text} |
...
<!-- lab:data-table rows=7 title="Mitosis vs. Meiosis Comparison" -->
...
| Do homologs pair up? | {fill:text} | {fill:text} |
| What separates in anaphase? | {fill:text} | {fill:text} |
...
<p style="font-size: 12px; margin-bottom: 8px;">Keep these aside until S-Phase. Tape each duplicate to its matching chromosome above at the center to form sister chromatids.</p>
