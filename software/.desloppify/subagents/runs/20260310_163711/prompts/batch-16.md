...
- scripts/generate_module_website.py
- scripts/generate_syllabus_renderings.py
...
- src/schedule/main.py
- src/speech_to_text/main.py
- src/text_to_speech/utils.py
- scripts/generate_module_renderings.py
...
Confirm or refute each with your own code reading. Report only confirmed defects.
  - [design_concern] scripts/flatten_published.py
  ...
  - [design_concern] src/content_processing/main.py
    summary: Design signals from smells
    question: Review the flagged patterns — are they design problems that need addressing, or acceptable given the file's role?
    evidence: Flagged by: smells
