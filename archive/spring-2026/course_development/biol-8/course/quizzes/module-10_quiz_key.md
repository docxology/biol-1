...
|----|--------|-------------|
| 1 | C | Epithelial tissue covers surfaces |
| 2 | D | Neurons are in nervous tissue |
| 3 | B | Connective tissue has abundant matrix |
| 4 | B | Thin simple squamous = good for diffusion |
| 5 | B | Blood is connective tissue (liquid matrix) |
| 6 | C | Skeletal = striated and voluntary |
| 7 | C | Stratified = multiple layers for protection |
...
| Location | Attached to bones | Heart | Organs, vessels |
...
- Rapidly divides to replace worn cells (high turnover)
- Selectively permeable to allow nutrient absorption
