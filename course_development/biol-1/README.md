...
Active Fall 2026 slide decks are generated from the structured module manifests. Each active module has a full-page classroom PDF and an instructor notes PDF in [`resources/slides/`](resources/slides/), with canonical HTML sources in `resources/slides/generated/`. Legacy imported PDFs are archived under `archive/fall-2026-legacy-slides/`.
