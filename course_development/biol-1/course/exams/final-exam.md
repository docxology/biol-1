...
**Instructions:** Unless a section says otherwise, answer **every** question in Parts A–C. For Part D, follow the prompt. Budget time so Part D receives a full essay-level answer.
...
**4.** The **atomic number** of an element equals the number of:
...
**5.** A **covalent bond** forms when atoms:
...
**6.** Ice floats on liquid water largely because:
...
**7.** **Monomers** are linked into polymers such as starch or proteins by reactions that often release water; this class of reaction is called:
    - A) Hydrolysis only
    - B) Transcription
    - C) Denaturation only
...
**8.** Which macromolecule class typically stores **hereditary** information in cells?
...
**10.** The **cell theory** includes the idea that:
...
**11.** Which organelle is the primary site of **aerobic ATP harvest** (cellular respiration) in many eukaryotes?
    - A) Chloroplast
    - B) Golgi apparatus
    - C) Mitochondrion
    - D) Ribosome
...
**12.** **Prokaryotic** cells lack which structure typical of **animal** eukaryotic cells?
...
**13.** The **fluid mosaic** model describes the plasma membrane as:
...
**14.** **Simple diffusion** of a small nonpolar molecule across a lipid bilayer occurs:
...
**15.** **Osmosis** refers specifically to:
...
**16.** **ATP** is useful to cells mainly because:
...
**19.** The central dogma in many cells reads **DNA → RNA → protein**. **Translation** refers to:
...
**20.** During **DNA replication**, new strands are elongated primarily by:
...
**21.** **RNA** differs from DNA in a typical introductory biology contrast because RNA:
...
**22.** A human **somatic** cell is diploid (2n); a mature **gamete** is:
    - A) Haploid (n)
    - B) Triploid always
...
**23.** **Crossing over** between homologous chromosomes primarily occurs during:
...
**24.** **Mitosis** followed by cytokinesis of one diploid parent cell typically yields:
...
**25.** Alternative versions of one gene (such as flower-color alleles) are called:
    - A) Phenotypes only
    - B) Chromatids
    - C) Alleles
    - D) Barr bodies
...
**26.** For complete dominance, cross **Aa × Aa**. Expected **phenotypic** ratio among offspring is often:
...
**27.** **Incomplete dominance** often yields offspring ratios such as **1 : 2 : 1** phenotypes when two heterozygotes mate because:
...
**28.** **Epigenetics** emphasizes changes in trait expression that:
...
**29.** DNA **methylation** associated with gene silencing fits the memory hook “methylation ≈ muting” because methylation often:
...
**30.** In female mammals, **X-inactivation** produces a dense **Barr body** because:
...
**32.** In standard **agarose gel electrophoresis**, DNA fragments migrate toward:
...
**33.** **CRISPR-Cas9** is widely described as a tool that can:
...
**34.** **Natural selection** requires heritable variation and differential reproductive success linked to traits in a given environment; which statement adds Darwin’s observation about numbers of offspring?
...
**35.** **Homologous** tetrapod limbs with different functions suggest:
...
**36.** **Evolutionary fitness** in population genetics usage emphasizes:
...
**38.** **Genetic drift** has **strongest** effects when:
...
**39.** The Hardy–Weinberg equilibrium serves chiefly as:
...
**40.** Different frog species breed in different seasons, preventing hybridization. This is a **prezygotic** barrier classified as:
...
**41.** Sterile **mule** hybrids illustrate:
...
**42.** A mountain range splits one fish species into non-interbreeding lineages—classic mode:
...
**43.** A population rising steeply when resources are abundant shows **J-shaped** **exponential** growth until limits bite; **logistic** growth differs mainly because:
...
**44.** A disease spreading faster when hosts are crowded is typically treated as:
...
**45.** In food webs, chemical nutrients cycle while energy from sunlight through producers is ultimately:
...
**1.** Maintaining stable internal conditions despite external fluctuations is called \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.

**2.** Water molecules stick to each other through \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ bonding (partial charges on O–H).

**3.** Cells take in large particles by vesicle wrapping using processes such as phagocytosis, a form of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.

**4.** Membrane-bound sac of hydrolytic enzymes that degrades worn cell parts in many animal cells: \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.

**5.** Organelles that modify, sort, and ship many proteins are stacks of the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.

**6.** High heat or harsh pH often unfolds a protein’s three-dimensional shape (without necessarily breaking every peptide bond); this loss of native structure is called \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.

**7.** Movement of **water** across a selectively permeable membrane, down its concentration gradient, is called \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.

**8.** In many eukaryotic cells, **aerobic ATP harvest** is concentrated in organelles called \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.

**9.** An organism with genotype **Aa** for one gene is \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ at that locus.

**10.** Type **AB** blood with both **A** and **B** alleles expressed illustrates \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.

**11.** DNA methylation that silences promoters without changing letter sequence is discussed under \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ along with histone changes.

**12.** After a random catastrophe removes most individuals, surviving allele frequencies may shift by drift through a \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ effect.

**13.** When a few colonists seed an island population, allele frequencies may reflect only colonists’ genes—a \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ effect.

**14.** The equilibrium \(p^2 + 2pq + q^2 = 1\) under ideal assumptions is tied to the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ population-genetics baseline model.

**15.** Fungi and bacteria returning nutrient elements from dead matter toward producers are major \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ in ecosystems.

---

## Part C: Integrated Short Answer (25 points)

*Answer **all five** questions below. Each is worth **5** points. Write clearly in **complete sentences**.*
