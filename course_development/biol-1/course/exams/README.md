...
**Comprehensive final:** `final-exam.md` + `final-exam_key.md` — **100 points** (45 MC, 15 fill-in with word bank, **seven** integrated short-answer prompts with **five**- or **seven**-question formats for **25** pts, one essay chosen from three prompts). Longer and broader than the **50-point** unit exams.
...
**`final-exam.md`** uses **100 points:** Part A **45** MC (three per module, modules **01–15**), Part B **15** fill-in terms drawn from a **19-word** bank (**four** decoys), Part C **seven** integrated short-answer prompts (**25** points total—**pick any five** worth **5** pts each, **or** answer **all seven** with points divided evenly), Part D **one** essay (**15** points) from three options.
