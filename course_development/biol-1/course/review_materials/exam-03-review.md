...
- **Descent with modification** (change over time from shared ancestors).  
- **Natural selection:** heritable **variation**, **overproduction** of offspring, **differential reproductive success** (fitness = relative reproductive success).  
...
## Module 13 — How populations evolve (microevolution)

### Focus ideas

- **Microevolution** = **change in allele frequencies** in a population over time.  
- **Five mechanisms:** mutation, **gene flow**, **genetic drift**, non-random mating (e.g. sexual selection), **natural selection**.  
- **Drift** matters most in **small** populations; **bottleneck** vs **founder** effects.  
...
## Module 14 — Macroevolution and speciation

### Focus ideas

- **Biological species concept** (interbreed in nature → viable fertile offspring; **reproductive isolation** from other such groups).  
- **Prezygotic** barriers (before zygote): habitat, **temporal**, behavioral, mechanical, gametic, etc.  
...
- **Exponential (J)** vs **logistic (S)** growth; **carrying capacity (K)**.  
- **Density-dependent** (competition, disease, predation often intensify with crowding) vs **density-independent** (e.g. many fires, some storms) regulation.  
...
**2.** In comparative anatomy, forelimb bones in different tetrapods that share structure from a common ancestor are called \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ structures (even if functions differ).

**3.** A population’s birth-weight curve can favor the middle; this mode of natural selection is \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ selection.

**4.** A barrier that works **before** a zygote forms—such as different breeding seasons—is a \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ barrier to reproduction.

**5.** A river splits a range; populations diverge in isolation—speciation that begins with **geography** is often \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ speciation.

**6.** Darwin’s phrase for evolution: species share ancestry and accrue change over time—\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ with modification.

**7.** A limiting factor that hits harder as a population **crowds** (e.g. more transmission of a parasite) is \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ regulation in many textbook examples.

**8.** A group of populations that interbreed in nature, producing viable fertile offspring, and is reproductively isolated from other such groups, fits the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ species concept (as presented in this unit).

**9.** Fungi and bacteria that recycle dead organic matter and return elements to the soil for producers are \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.

**10.** When a population’s average trait value shifts toward **one** extreme of the range (e.g. darker moths on sooty trees), the pattern is \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ selection.
<!-- /lab:reflection -->
...
**2. (Module 13)** Compare **genetic drift** to **natural selection** (what drives change in each?). Give **one** example of **bottleneck** or **founder** effect in plain words.

{fill:textarea rows=5}

**3. (Module 14)** Classify these as **prezygotic** or **postzygotic**: (a) different courtship song; (b) hybrid is sterile. Then state one difference between **allopatric** and **sympatric** speciation in one or two sentences.
...
| I can… | ✓ |
|--------|---|
| State natural selection as variation + overproduction + unequal contribution to the next generation | [ ] |
| Give **one** type of **evidence** (fossil, anatomy, biogeography, molecular) and what it supports | [ ] |
| Name the **five** microevolution mechanisms; contrast drift vs **gene flow** | [ ] |
| Describe directional / stabilizing / **disruptive** selection; explain bottleneck **vs** founder | [ ] |
| Classify prezygotic **vs** postzygotic; allopatric **vs** sympatric; biological species idea | [ ] |
| Contrast J vs S growth; K; density-dependent **vs** independent; energy **flow** **vs** nutrient **cycling**; 10% rule | [ ] |

**Two terms I still mix up:** {fill:textarea rows=2}
...
*Exam 03 review worksheet, Modules 12–16. BIOL-1: General Biology (Pelican Bay), Fall 2026 — College of the Redwoods*
