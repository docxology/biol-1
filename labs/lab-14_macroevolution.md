# Lab 14: Macroevolution (Module 14)
...
| **Prezygotic** | Mating, timing, or gametes “don’t meet” the way you’d need for a zygote (first line of **no gene flow**). |
...
- Prezygotic: {fill:text}  
- Postzygotic: {fill:text}
...
<!-- lab:data-table rows=4 title="Part 2 — Prezygotic or postzygotic" -->
| Field report | Pre or Post? |
|--------------|-------------|
| Pollen of Species X never starts tubes on Species Y stigmas. | {fill:text} |
| F1 hybrid salamanders survive but have **0%** successful mating as adults. | {fill:text} |
| Fireflies flash different patterns; males and females ignore the wrong pattern. | {fill:text} |
...
<!-- lab:data-table rows=4 title="Part 2 — Barrier sub-type" -->
...
<!-- lab:data-table rows=2 title="Part 3 — Allopatric or sympatric" -->
| Scenario | Allopatric or Sympatric? |
|----------|-------------------------|
| Canyon splits a valley; populations diverge in **isolation**. | {fill:text} |
| A plant instantly inherits **4n** chromosomes and can only breed with other **4n** plants in the **same** meadow. | {fill:text} |
<!-- /lab:data-table -->
...
*Lab 15 — Macroevolution. Speciation Response Team scenario (paper lab).*
